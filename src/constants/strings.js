export const show_details = "true";
export const dont_show_details = "false";
export const is_recommending_movies = "loading";
export const recommendation_successful = "success";
export const recommendation_failed = "error";
